...
<html class='v2' dir='ltr' lang='vi' xmlns='http://www.w3.org/1999/xhtml' xmlns:b='http://www.google.com/2005/gml/b' xmlns:data='http://www.google.com/2005/gml/data' xmlns:expr='http://www.google.com/2005/gml/expr'>
    <head>
        <title>Nguyễn Hồng Anh Đức</title>
<meta content='width=device-width, user-scalable=no, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0' name='viewport'/>
<link href='//sv3.anh365.com/images/2022/04/25/FB_IMG_1650879315909.jpg' rel='shortcut icon' type='image/x-icon'/>
<meta content='https://sv3.anh365.com/images/2022/04/25/Screenshot_20220425-191637_Chrome.md.jpg' property='og:image'/>
...
<img alt='profile card' src='https://sv3.anh365.com/images/2022/04/25/FB_IMG_1650879315909.jpg'/>
</div>
<div class='profile-card__cnt js-profile-cnt'>
<div class='profile-card__name'> Nguyễn Hồng Anh Đức <i class='fa fa-check-circle' style='color:rgb(17, 143, 249)' title='Verified Author'></i>
</div>
<div class='profile-card__txt'>Tôi là <b>Nguyễn Hồng Anh Đức</b>, một cậu học sinh cấp 2 sắp lên cấp 3 yeye chuyên <b>Hỗ trợ Dịch vụ Mạng Xã Hội</b> với ước mơ trở thành một Developer chuyên nghiệp. Tôi thích khám phá, tìm tòi và học hỏi những điều thú vị trên mạng Internet. Biết đôi chút về <i>PHP, Dịch Vụ Mạng Xã Hội</i>...</div>
<div class='profile-card-loc'>
<span class='profile-card-loc__icon'>
<svg class='icon'><use xlink:href='#icon-location'></use></svg>
</span>
<span class='profile-card-loc__txt'>Pleiku, Gia Lai</span>
</div>
<div class='profile-card-inf'>
<div class='profile-card-inf__item'>
<div class='profile-card-inf__title' id='count-followers'>12.222</div>
...
<a class='profile-card-social__item facebook' href='https://www.facebook.com/Duck417' target='_blank'>
<span class='icon-font'>
<svg class='icon'><use xlink:href='#icon-facebook'></use></svg>
</span>
</a>
<a class='profile-card-social__item instagram' href='https://www.instagram.com/duckjake417' target='_blank'>
<span class='icon-font'>
<svg class='icon'><use xlink:href='#icon-instagram'></use></svg>
</span>
</a>
<a class='profile-card-social__item link' href='https://baotrenoitieng.blogspot.com/2022/04/nguyen-hong-anh-uc-chang-trai-sinh-nam.html' target='_blank'>
<span class='icon-font'>
...
<button class='profile-card__button button--blue' >Momo: 0935723340</button>
<button class='profile-card__button button--orange' >MB: 11133668856789</button>
